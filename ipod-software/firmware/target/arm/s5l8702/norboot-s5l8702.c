...
// TODO: renombrar bootflash_im3_sz() o norboot_im3_sz() nb_im3_sz()
/* return full IM3 size aligned to NOR sector size */
unsigned im3_nor_sz(struct Im3Info* hinfo)
{
    return ALIGN_UP(IM3HDR_SZ + get_uint32le(hinfo->data_sz), 0x1000);
...
// TODO: norboot_im3_read(), en s5l8720 podriamos moner nandboot_im3_read(), depues norboot_ y nandboot_ se podrian ir a boot-s5l8702.c
