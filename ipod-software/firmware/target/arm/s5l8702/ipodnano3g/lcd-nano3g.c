...
// XXX XXX XXX: para los displays del nano3g ver ili9327, que dice que soporta MIDI interface command de 8-bit y param de 8-bit
...
// TODO TODO TODO ???: poner algo mas al final de la secuencia de init ???, el bootloader sin un sleep va muy justo ()
...
{
    [LCD_TYPE_38B3] = {
        .lcd_type   = LCD_TYPE_38B3,
        .mpuiface   = LCD_MPUIFACE_PAR9,
    #if defined(HAVE_LCD_SLEEP) || defined(HAVE_LCD_SHUTDOWN)
        .seq_sleep  = (void*) lcd_sleep_seq_03,
    #endif
    #ifdef HAVE_LCD_SLEEP
        .seq_awake  = (void*) lcd_awake_seq_01234,
    #endif
    #ifdef BOOTLOADER
    ...
    [LCD_TYPE_58XX] = {
        .lcd_type   = LCD_TYPE_58XX,
        .mpuiface   = LCD_MPUIFACE_PAR9,
    #if defined(HAVE_LCD_SLEEP) || defined(HAVE_LCD_SHUTDOWN)
        .seq_sleep  = (void*) lcd_sleep_seq_4,
    #endif
    #ifdef HAVE_LCD_SLEEP
        .seq_awake  = (void*) lcd_awake_seq_01234,
    #endif
    #ifdef BOOTLOADER
        .seq_init   = (void*) lcd_init_seq_4,
    #endif
    },
};
