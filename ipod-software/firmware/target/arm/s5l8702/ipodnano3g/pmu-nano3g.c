...
{
//     return !!(pmu_read(D1671_REG_STATUSA) & D1671_STATUSA_VADAPTOR);
...
int usb_detect(void)
{
//     return !!(pmu_read(D1671_REG_STATUSA) & D1671_STATUSA_VBUS);
    return usb_status;
}
...
int eint_cnt1 = 0;     // XXX XXX XXX: DEBUG
int eint_cnt2 = 0;     // XXX XXX XXX: DEBUG
