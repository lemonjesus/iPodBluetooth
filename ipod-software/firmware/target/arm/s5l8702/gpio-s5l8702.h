...
#define EIC_BASE 0x39a00080
#else
#define EIC_BASE 0x39700080
#endif

#define EIC_INTLEVEL(g) (*((REG32_PTR_T)(EIC_BASE + 0x00 + 4*(g))))
#define EIC_INTSTAT(g)  (*((REG32_PTR_T)(EIC_BASE + 0x20 + 4*(g))))
#define EIC_INTEN(g)    (*((REG32_PTR_T)(EIC_BASE + 0x40 + 4*(g))))
#define EIC_INTTYPE(g)  (*((REG32_PTR_T)(EIC_BASE + 0x60 + 4*(g))))
