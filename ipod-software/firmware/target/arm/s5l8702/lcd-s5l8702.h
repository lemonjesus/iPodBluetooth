...
//     SLEEP,      /* unit: 10 ms. */
    SLEEP,      /* unit: RB tick */                 // TODO: la unidad en ms. pero usando HZ
...
#define CMD16           (CMD)   /* send command with no data */             // TODO: por que no usar MREG16(0) ???
