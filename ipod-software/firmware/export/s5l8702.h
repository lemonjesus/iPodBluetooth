...
#define CLKCON6      (*((volatile uint32_t*)(0x3C500070)))
#endif
...
/* these registers are similar to s5l8700x */
...
#define MIU_REG(off)    (*((uint32_t volatile*)(MIU_BASE + (off))))
#define MIUCOM          (*((uint32_t volatile*)(0x3d700104)))
#define MIUMRS          (*((uint32_t volatile*)(0x3d700110)))

#define UNK3E000008     (*((uint32_t volatile*)(0x3e000008)))
#endif
...
#if CONFIG_CPU == S5L8720
/* TBC: 64-bit timer */
#define TICNTH       (*((uint32_t volatile*)(0x3C700080)))
#define TICNTL       (*((uint32_t volatile*)(0x3C700084)))
#define TIUNK08      (*((uint32_t volatile*)(0x3C700088)))
#define TIUNK0C      (*((uint32_t volatile*)(0x3C70008C)))      // TBC: DATA0H
#define TIUNK10      (*((uint32_t volatile*)(0x3C700090)))      //      DATA0L
#define TIUNK14      (*((uint32_t volatile*)(0x3C700094)))      //      DATA1H
#define TIUNK18      (*((uint32_t volatile*)(0x3C700098)))      //      DATA1L
#endif
...
#define VIC0EDGE0             (*((uint32_t volatile*)(0x38E02000)))     // TBC: INTENABLE
#define VIC1EDGE0             (*((uint32_t volatile*)(0x38E02004)))
#define VIC0EDGE1             (*((uint32_t volatile*)(0x38E02008)))     // TBC: INTENCLEAR
#define VIC1EDGE1             (*((uint32_t volatile*)(0x38E0200C)))
...
#define GPIOCMD       (*((uint32_t volatile*)(0x3cf001e0)))
#define GPIOUNK388    (*((uint32_t volatile*)(0x3cf00388)))
#define GPIOUNK384    (*((uint32_t volatile*)(0x3cf00384)))
#endif
...
#if CONFIG_CPU == S5L8720
#define SPIUNK3C(i)   (*((uint32_t volatile*)(SPIBASE(i) + 0x3c)))
#define SPIUNK40(i)   (*((uint32_t volatile*)(SPIBASE(i) + 0x40)))
#define SPIUNK4C(i)   (*((uint32_t volatile*)(SPIBASE(i) + 0x4c)))
...
#if CONFIG_CPU == S5L8720
#define SHA1UNK10     (*((uint32_t volatile*)(0x38000010)))
#define SHA1UNK80     (*((uint32_t volatile*)(0x38000080)))
#endif
...
#define LCD_RCMD   (*((uint32_t volatile*)(0x3830000c)))
#define LCD_RDATA  (*((uint32_t volatile*)(0x38300010)))
#define LCD_DBUFF  (*((uint32_t volatile*)(0x38300014)))
#define LCD_INTCON (*((uint32_t volatile*)(0x38300018)))
...
#if CONFIG_CPU == S5L8720
#define CHIPID_INFO     (*((uint32_t volatile*)(0x3d100008)))
#endif
...
#define CLOCKGATE_UNK14     14      // XXX: esta tambien podria ser DMAC0
...
// #define CLOCKGATE_I2S1      42
#define CLOCKGATE_SPI1      43
#define CLOCKGATE_GPIO      44      // TBC TBC TBC
#define CLOCKGATE_UNK45     45      // XXX: es usa en peicore, tambien en s5l8702, esta relacionado con 0x3d00_0000 (secure boot ???)
#define CLOCKGATE_CHIPID    46
...
#define CLOCKGATE_UNK104    104     // XXX: la usa peicore, relacionada con 0x3880_0000
#define CLOCKGATE_UNK14_2   107

// #define CLOCKGATE_UNK109    109      // XXX: se cuelga si la deshabilitamos
...
#define CLOCKGATE_LCD_2     144     // TBC TBC TBC
...
#define IRQ_SPI0        9               // XXX: TBC
#define IRQ_SPI1        10              // XXX: TBC
#define IRQ_SPI2        11              // XXX: TBC
#define IRQ_LCD         14
#define IRQ_DMAC(d)     (16+(d))
#define IRQ_DMAC0       16
#define IRQ_DMAC1       17
#define IRQ_USB_FUNC    19
#define IRQ_NAND        20  // TODO: TBC: es asi en s5l8900
...
#define IRQ_AES         39
#define IRQ_SHA         40
#define IRQ_NANDECC     43  // TODO: TBC: es asi en s5l8900
#define IRQ_MMC         44
