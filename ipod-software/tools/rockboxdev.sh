...
do
    ...
    case $arch in
        ...
        [Aa])
            ...
            build "binutils" "arm-none-eabi" "2.20.1" "binutils-2.20.1-ld-thumb-interwork-long-call.diff binutils-2.20.1-texinfo-fix.diff" "$binopts --disable-werror"
            build "gcc" "arm-none-eabi" "4.4.4" "rockbox-multilibs-noexceptions-arm-none-eabi-gcc-4.4.2_1.diff" "$gccopts MAKEINFO=missing" "gmp mpfr"
            ;;
        [Rr])
